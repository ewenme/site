/******/ ;(function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = './srcjs/react-tools.js'),
  )
  /******/
})(
  /************************************************************************/
  ...
  \************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var shiny__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! shiny */ 'shiny')
        /* harmony import */ var shiny__WEBPACK_IMPORTED_MODULE_2___default =
          /*#__PURE__*/ __webpack_require__.n(
            shiny__WEBPACK_IMPORTED_MODULE_2__,
          )
        /* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! jquery */ 'jquery')
        /* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        function reactShinyInput(selector, name, component, options) {
          ...
          shiny__WEBPACK_IMPORTED_MODULE_2___default.a.inputBindings.register(
            new /*#__PURE__*/ ((function (_Shiny$InputBinding) {
              ...
              _createClass(_class, [
                ...
                },
                {
                  ...
                  value: function setValue(el, value) {
                     ...
                     */
                    if (
                      jquery__WEBPACK_IMPORTED_MODULE_3___default()(el).data(
                        'callback',
                      ) !== undefined
                    ) {
                      this.setInputValue(el, value)
                ...
                },
                {
                  ...
                  value: function initialize(el) {
                    jquery__WEBPACK_IMPORTED_MODULE_3___default()(el).data(
                      'value',
                      JSON.parse(
                        jquery__WEBPACK_IMPORTED_MODULE_3___default()(el)
                          .next()
                          .text(),
                      ),
                    )
                ...
                },
                {
                  ...
                  value: function getType(el) {
                    if (typeof options.type === 'function') {
                      ...
                      throw new Error(
                        'options.type must be false, a string, or a function',
                      )
                    }
                  },
                },
              ...
              return _class
            })(shiny__WEBPACK_IMPORTED_MODULE_2___default.a.InputBinding))(),
            name,
          )
        }
  ...
  \******************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./widget */ './srcjs/widget.js')
        /* harmony import */ var _input__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./input */ './srcjs/input.js')

        window.reactR = {
          reactShinyInput:
            _input__WEBPACK_IMPORTED_MODULE_1__['reactShinyInput'],
  ...
  \*************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function hydrate(components, tag) {
          ...
          if (
            tag.name[0] === tag.name[0].toUpperCase() &&
            !components.hasOwnProperty(tag.name)
          ) {
            throw new Error('Unknown component: ' + tag.name)
          }

          var elem = components.hasOwnProperty(tag.name)
              ? components[tag.name]
              : tag.name,
                ...
                renderValue = function renderValue(value) {
                  if (actualOptions.renderOnResize) {
                    ...
                    if (_typeof(value.tag) === 'object') {
                      value.tag.attribs[actualOptions['widthProperty']] =
                        formatDimension(width)
                      value.tag.attribs[actualOptions['heightProperty']] =
                  ...
                  this.instance.component = ReactDOM.render(
